...
public class NutritionFacts2 {
	...
	public static class NutritionFactsBuilder implements
			Builder<NutritionFacts2> {
		...
		@Override
		public NutritionFacts2 builder() {
			return new NutritionFacts2(this);
		}
	}

	private NutritionFacts2(NutritionFactsBuilder builder) {
